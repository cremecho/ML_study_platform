...
#     import PIL.Image
#     from cv2 import cv2
#     img = cv2.imread(r'C:\Users\Cremecho\Desktop\cats_purr.jpg')
#     img = cv2.cvtColor(img, cv2.COLOR_RGB2GRAY)
#
#
#     import scipy.io as scio
#     data = scio.loadmat('../dataset/lighting/20221027_0003t.mat')['image']
#     data = data.reshape(640*480, 263)
#
#     h = rpcaADMM(data)
#     x1,x2,x3 = h['X1_admm'], h['X2_admm'], h['X3_admm']
#     rh = lambda x: x.reshape(640,480,263)
#     x1,x2,x3 = rh(x1), rh(x2), rh(x3)
#     X = np.stack([x1,x2,x3])
#     np.save('rpca.npy', X)
#
...
# def pca2(x):
#     x = x.squeeze()
#     x = x.reshape(640* 480, 263)
#     from sklearn.decomposition import PCA
#     pca = PCA(1)
#     pca.fit(x)
#     img = np.dot(x, pca.components_.transpose())
#     img = img.reshape(640, 480)
#     plt.figure()
#     plt.imshow(img)
#     plt.show()
#
